...
export default function Hero() {
    ...
    return (
        <>
            <Header />
            <section id = 'hero'>
                <div className='partOne' style={{marginTop: marginFirstSecond + 'vh', transition: (transition) ? '1000ms ease' : 'none'}}>
                    <div>
                ...
                <div className='partTwo' style={{marginTop: margin + 'vh', transition: (transition) ? '1000ms ease' : 'none'}}>
                    <div>
                ...
                <div className='partThree' style={{marginTop: marginFirstSecond + 'vh', transition: (transition) ? '1000ms ease' : 'none'}}>
                    <div>
                ...
                <div className="hedings" style={{left: hedingLeft + 'vw'}}>
                    <div>
                        <h1 className={(hedingLeft === 0) ? 'hedingAnimation' : ''}>Najbolje pranje vozila</h1>
                        <h3 className={(hedingLeft === 0) ? 'hedingAnimationH3' : ''}>Sigurna opcija za vaseg mezimca</h3>
                    </div>
                    <div>
                        <h1 className={(hedingLeft === -100) ? 'hedingAnimation' : ''}>Masinsko pranje tepiha</h1>
                        <h3 className={(hedingLeft === -100) ? 'hedingAnimationH3' : ''}>Za potpunu cistocu</h3>
                    </div>
                    <div>
                        <h1 className={(hedingLeft === -200) ? 'hedingAnimation' : ''}>Poliranje vozila</h1>
                        <h3 className={(hedingLeft === -200) ? 'hedingAnimationH3' : ''}>Zastita u nekoliko slojeva</h3>
                    </div>
                    <div>
                        <h1 className={(hedingLeft === -300) ? 'hedingAnimation' : ''}>Masinsko poliranje farova</h1>
                        <h3 className={(hedingLeft === -300) ? 'hedingAnimationH3' : ''}>Umesto novih farova</h3>
                    </div>
                    <div>
                        <h1 className={(hedingLeft === -400) ? 'hedingAnimation' : ''}>Dubinsko pranje vozila</h1>
                        <h3 className={(hedingLeft === -400) ? 'hedingAnimationH3' : ''}>Kao nov i lepo mirise</h3>
                    </div>
                </div>
            </section>
            <section id='info'>
                <div>
                    ...
                    <p>060/53 86 187</p>
                    <p><a href='mailto:perionicavasic2018@gmail.com'>perionicavasic2018@gmail.com</a></p>
                </div>
            </section>
        </>
    )
