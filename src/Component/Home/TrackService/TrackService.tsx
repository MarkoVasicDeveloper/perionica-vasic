    ...
    <section id="track-service" ref={myPosition}>
      <div className={animate ? "info animateInfoTrack" : "info"}>
        ...
        <div className="track-info-p">
          <p>
            <span> STOP CETKAMA! </span>Nema potrebe za grebanjem vaseg kamiona!
            Savremeno pranje kamiona podrazumeva upotrebu hemije koja rastvara
            svu prljavstinu, koja se potom spere sa vozila.
          </p>
        </div>
      </div>
      <div
        className={animate ? "track-photo animateTrack-photo" : "track-photo"}
      >
